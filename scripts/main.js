...
// Function to adjust the layout based on the device type
function adjustLayout() {
  ...
  if (isMobileDevice()) {
      ...
      body.style.backgroundColor = '#f0f0f0'; // Example background color for mobile
      console.log('Mobile layout applied');
  } else {
      // Desktop-specific adjustments
      body.style.fontSize = '18px';
      body.style.padding = '20px';
      body.style.backgroundColor = '#ffffff'; // Example background color for desktop
      console.log('Desktop layout applied');
  }
}

// Event listener for window resize to adjust layout dynamically
window.addEventListener('resize', adjustLayout);

// Initial call to adjust layout when the script loads
adjustLayout();